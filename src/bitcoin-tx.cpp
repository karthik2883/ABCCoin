...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s abccoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  abccoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded abccoin transaction") + "\n" +
              "  abccoin-tx [options] -create [commands]   " + _("Create hex-encoded abccoin transaction") + "\n" +
              "\n";

...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.abccoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.abccointools.com", true);
        vSeeds.emplace_back("dnsseed.abccoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.abccointools.com", true);
        vSeeds.emplace_back("seed-b.abccoin.loshan.co.uk", true);

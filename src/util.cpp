...
const char * const BITCOIN_CONF_FILENAME = "abccoin.conf";
const char * const BITCOIN_PID_FILENAME = "abccoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "abccoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/abccoin";
#else
    // Unix
    return pathRet / ".abccoin";
#endif
#endif
}

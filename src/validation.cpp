...
#if defined(NDEBUG)
# error "abccoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "abccoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s ABC additional fees, %d delta bytes\n",
